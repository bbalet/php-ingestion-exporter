...
/**
 * A FragmentCollection is a set of Fragments on which we can iterate
 */
class FragmentCollection implements \Countable, \Iterator, \ArrayAccess {
    /**
     * Concrete storage of the collection of fragments
     * @var array
     */
    private $values = [];

    /**
     * Index of the array when we iterate of it
     * @var int
     */
    private $position = 0;
